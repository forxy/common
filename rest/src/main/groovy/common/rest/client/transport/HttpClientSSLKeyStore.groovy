 ...
 */
final class HttpClientSSLKeyStore {
     ...
     */
    HttpClientSSLKeyStore(final InputStream trustStoreStream, final String trustStorePassword) throws Exception {
     ...
     * {@link org.apache.http.conn.ssl.SSLConnectionSocketFactory} returned by the {@link #getSocketFactory()} method
     * @throws Exception when there is a problem reading the <tt>truststore</tt> file from the provided stream
     */
    HttpClientSSLKeyStore(final InputStream trustStoreStream, final String trustStorePassword,
     ...
     */
    HttpClientSSLKeyStore(final InputStream keyStoreStream, final String keyStorePassword,
    ...
    private static KeyStore loadKeyStore(final InputStream input, final String password) throws Exception {
     ...
     */
    LayeredConnectionSocketFactory getSocketFactory() {
