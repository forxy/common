...
public abstract class EncodingHelper {
     ...
     */
    public static Charset getCharsetByAlias(final String alias) {
     ...
     * @return bytes
     */
    public static byte[] toUTFBytes(final String input) {
        byte[] result = null;
        try {
     ...
     * @return string
     */
    public static String toUTFString(final byte[] input) {
        String result = null;
        try {
     ...
     * @return string
     */
    public static String toCharsetString(final byte[] input, final Charset charset) {
        String result = null;
        try {
     ...
     * @return decoded data
     */
    public static String safeURLDecode(final String encodedData, final Charset charset) {
        String result = null;
        if (encodedData != null) {
            try {
